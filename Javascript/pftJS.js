                            ...
                            if(event.keyCode == 13 & locationObj.textField.value.length > 0)
                                {
                                    ...
                                    $.getJSON('https://api.openweathermap.org/data/2.5/weather?q=' + newLocation + ',GB&APPID=c36391aff2aa7383d22acf099f99cb56', function(newjson) {
...
function test() {
    ...
    $.ajax({
        url : 'https://api.openweathermap.org/data/2.5/weather?q=leeds,GB&APPID=c36391aff2aa7383d22acf099f99cb56',
        dataType : 'jsonp',
...
function jsonCallback(json) {
    ...
    humidity.innerHTML = json.main.temp + 'c';
}
